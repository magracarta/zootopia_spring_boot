...
<section >
				...
				<c:choose>
					<c:when test="${communityVO.userid == loginUser.userid}">
						<div class="button_container">
							<input class="button1" type="button" value="수정" onclick="location.href='communityUpdateForm?gseq=${communityVO.gseq}'">
	...
	<div class="detailcontainer">
		<div class="content" >
			...
			<div class="buttonWrap">
				...
				<input class="button3" type="button" value="목록으로" onclick="location.href='communityBoard'">
			</div>
		</div>
	</div>
	...
	<div class="comment-section">
		...
		<c:if test="${not empty loginUser.userid}">
			<form class="commentwrite" action="writeCommunityReply" method="post">
					...
					<li>
						...
						<c:if test="${loginUser.userid == reply.userid}">
							<div class="replyUpdateForm">
								<form action="updateCommunityReply" method="post">
